...
const Login = () => {
  return (
    <div className=" flex justify-center p-8 sm:px-6 lg:px-8 items-center">
      ...
      <div className="max-w-md w-full space-y-4 p-8 bg-gray-300 rounded-xl z-10">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember_me"
                type="checkbox"
                className="h-4 w-4 bg-indigo-500 focus:ring-indigo-400 border-gray-300 rounded" required
              />
              <label
                htmlFor="remember_me"
